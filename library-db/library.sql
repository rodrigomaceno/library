...
-- -----------------------------------------------------
-- Table `mydb`.`AccountPreferences`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`AccountPreferences` (
  `id` INT NOT NULL,
  `Accounts_id` INT NOT NULL,
  `Preferences_idPreferences` INT NOT NULL,
  PRIMARY KEY (`id`, `Accounts_id`, `Preferences_idPreferences`),
  INDEX `fk_Accounts_has_Preferences_Preferences1_idx` (`Preferences_idPreferences` ASC) VISIBLE,
  INDEX `fk_Accounts_has_Preferences_Accounts1_idx` (`Accounts_id` ASC) VISIBLE,
  CONSTRAINT `fk_Accounts_has_Preferences_Accounts1`
    FOREIGN KEY (`Accounts_id`)
    REFERENCES `mydb`.`Accounts` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Accounts_has_Preferences_Preferences1`
    FOREIGN KEY (`Preferences_idPreferences`)
