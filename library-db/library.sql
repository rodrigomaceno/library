...
CREATE TABLE IF NOT EXISTS `mydb`.`Reservations` (
  ...
  `Accounts_id1` INT NOT NULL,
  PRIMARY KEY (`idReservations`, `Accounts_id`, `DVDs_title`, `DVDs_author`, `isbn`, `CDs_title`, `CDs_artist`, `Accounts_id1`),
  ...
  INDEX `fk_Reservations_Accounts1_idx` (`Accounts_id1` ASC) VISIBLE,
